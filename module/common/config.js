export const CLEENMAIN = {
  ...
  weapon: {
    category: {
      standard: { label: "CLEENMAIN.weapon.category.standard" },
      war: { label: "CLEENMAIN.weapon.category.war" },
      heavy: { label: "CLEENMAIN.weapon.category.heavy" },
    },
    type: {
      melee: { label: "CLEENMAIN.weapon.type.melee" },
      ranged: { label: "CLEENMAIN.weapon.type.ranged" },
    },
  },
  armor: {
    category: {
      standard: { label: "CLEENMAIN.armor.category.standard" },
      war: { label: "CLEENMAIN.armor.category.war" },
      heavy: { label: "CLEENMAIN.armor.category.heavy" },
      shield: { label: "CLEENMAIN.armor.category.shield" },
    },
  },
  npcSkills: [
  ...
  npcCategory: {
    support: { label: "CLEENMAIN.npccategory.support" },
    secondfiddle: { label: "CLEENMAIN.npccategory.secondfiddle" },
    boss: { label: "CLEENMAIN.npccategory.boss" },
  },
